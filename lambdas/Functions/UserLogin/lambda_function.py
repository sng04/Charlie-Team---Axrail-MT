"""
UserLogin Lambda Function

Authenticates regular users via Cognito and returns JWT tokens.
"""
...
from auth_utils import user_login
...
def lambda_handler(event: dict, context: Any) -> dict:
    ...
    try:
        ...
        result = user_login(data["username"], data["password"])
        
        if "challenge" in result:
            return createResponse(200, "Password change required", result)
        
        return createResponse(200, "User login successful", result)
